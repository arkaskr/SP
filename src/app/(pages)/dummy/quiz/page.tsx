...
const Page: React.FC = () => {
  ...
  useEffect(() => {
    const fetchquizTests = async () => {
      ...
      try {
        ...
        console.error("Error fetching Quizes:", e);
        setError("Failed to load Quizes. Please try again later.");
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="container mx-auto p-4">
        <div className="bg-accent py-16 text-center mb-8 rounded-lg shadow-lg">
          <h1 className="text-4xl font-bold mb-4">Quizes</h1>
          <p className="text-xl">
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="bg-accent py-16 text-center mb-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold mb-4">Quizes</h1>
        <p className="text-xl">Master your skills with targeted quiz exams</p>
      </div>
