...
const Page: React.FC = () => {
    ...
    return (
      <div className="container mx-auto p-4">
        <div className="bg-accent py-16 text-center mb-8 rounded-lg shadow-lg">
          <h1 className="text-4xl font-bold mb-4">PYQs</h1>
          <p className="text-xl">Loading your personalized pyq experience...</p>
        </div>
        <Loading />
      </div>
    );
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="bg-accent py-16 text-center mb-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold mb-4">PYQs</h1>
        <p className="text-xl">Master your skills with targeted pyq exams</p>
      </div>
      ...
      {filteredExams.length === 0 && (
        <div className="text-center py-12 bg-slate-100 dark:bg-slate-800 rounded-lg">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 mb-2">
            No PYQs found matching your filters
          </p>
