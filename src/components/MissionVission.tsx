  ...
  return (
    <section className="px-6 py-12 max-w-7xl mx-auto text-center">
      ...
      <p className="text-gray-600 max-w-6xl mx-auto mb-12 text-base sm:text-lg leading-relaxed">
        Empowering students to achieve their academic and professional dreams through expert guidance and personalized support
      </p>

      {/* Card Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 place-items-center">
        <div className="transform transition duration-300 hover:shadow-2xl hover:scale-105">
          <Card
            ...
            sectionId="vision"
            className="w-full max-w-sm h-[600px] bg-blue-100 rounded-3xl shadow-md p-6"
          />
        </div>
        <div className="transform transition duration-300 hover:shadow-2xl hover:scale-105">
          <Card
