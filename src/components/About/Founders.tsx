...
const founders = [
  ...
  {
    name: "Hrithik Chowdhury",
    role: "Co- founder and CTO",
    image: "/assets/AboutUs/Founders/HrithikChowdhury.jpg",
    linkedin: "https://in.linkedin.com/in/hrithik-chowdhury-35b511317",
  },
];

export const FounderDisplay = () => {
  return (
    <div className="max-w-[90rem] mx-auto p-6 " id="founders" 
    // style={{
